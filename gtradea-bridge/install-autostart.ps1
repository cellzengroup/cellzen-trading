# Registers the Cellzen gtradea bridge to start automatically (and invisibly) at
...
$lnkPath = Join-Path $startup 'Cellzen gtradea Bridge.lnk'
...
$s.Description      = 'Cellzen gtradea 1688 bridge'
$s.Save()

Write-Host ''
Write-Host '  Done! The Cellzen gtradea bridge will now start automatically and' -ForegroundColor Green
