  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" style={{ width: "100vw", marginLeft: "calc(-50vw + 50%)", marginTop: "-2rem", marginBottom: "-2rem" }}>
      <main className="flex-grow">
        ...
        <section className="bg-white pt-32 pb-20">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="grid items-start gap-16 lg:grid-cols-2">
              ...
              <div>
                <h1 className="premium-font-galdgderbold text-4xl text-[#412460] sm:text-5xl leading-tight">
                  We are always ready to help you and answer your questions
                </h1>

                <p className="mt-6 text-sm leading-relaxed text-[#2D2D2D]/50 max-w-md">
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="mt-3 flex items-center gap-3">
                        <a href="#" className="text-[#2D2D2D]/40 transition hover:text-[#412460]" aria-label="Facebook">
                        ...
                        <a href="#" className="text-[#2D2D2D]/40 transition hover:text-[#412460]" aria-label="Instagram">
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="5" /><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor" stroke="none" /></svg>
                        </a>
                        <a href="#" className="text-[#2D2D2D]/40 transition hover:text-[#412460]" aria-label="LinkedIn">
                          <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2zM4 6a2 2 0 100-4 2 2 0 000 4z"/></svg>
                        </a>
                        <a href="#" className="text-[#2D2D2D]/40 transition hover:text-[#412460]" aria-label="WeChat">
                          <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M8.5 11a1 1 0 100-2 1 1 0 000 2zm5-1a1 1 0 11-2 0 1 1 0 012 0zm-1.27 5.88c-2.94.36-5.58-.7-6.88-2.54-.2.02-.4.04-.6.04C2.11 13.38 0 11.5 0 9.19S2.11 5 4.75 5c2.3 0 4.2 1.44 4.63 3.38.37-.06.75-.1 1.12-.1 3.59 0 6.5 2.46 6.5 5.5 0 1.17-.42 2.26-1.14 3.15.28 1.07.89 2.07.89 2.07s-1.97-.35-2.82-.82c-.59.2-1.22.34-1.89.38a6.7 6.7 0 01-.41.02z"/></svg>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-[#412460]/5 backdrop-blur-sm p-8 sm:p-10">
                <h2 className="premium-font-galdgdersemi text-2xl text-[#412460]">Get in Touch</h2>
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#412460]/10 text-[#412460] mb-4">
                      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <h3 className="text-xl font-bold text-[#2D2D2D]">Thank You for Your Inquiry!</h3>
                    <p className="mt-2 text-sm text-[#2D2D2D]/60">
                      We've received your message and will get back to you within 24 hours.
                    </p>
                    <button
                      onClick={() => { setSubmitted(false); setForm({ name: "", email: "", phone: "", country: "", message: "" }); }}
                      className="mt-6 w-full bg-[#412460] px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-[#412460]/90"
                    >
        ...
        {/* ═══ SECTION 2 — How to Work With Us (Steps) ═══ */}
        <section className="border-t border-[#2D2D2D]/8 bg-white py-20">
          <div className="mx-auto max-w-6xl px-6">
            <h2 className="premium-font-galdgdersemi text-2xl text-[#412460] italic mb-14">
              How to work with Cellzen Trading
            </h2>
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {STEPS.map((step) => (
                <div key={step.num} className="flex flex-col items-start">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#412460] text-sm font-bold text-[#412460]">
                    {step.num}
                  </div>
                  <h3 className="mt-4 text-sm font-bold text-[#2D2D2D]">{step.title}</h3>
                  <p className="mt-2 text-xs leading-relaxed text-[#2D2D2D]/50">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
