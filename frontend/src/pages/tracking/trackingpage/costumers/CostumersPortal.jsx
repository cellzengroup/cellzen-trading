    ...
    <div ref={dropdownRef} className="relative">
      ...
      >
        ...
        <div className="hidden sm:block text-left">
          <p className="text-xs font-semibold text-[#2D2D2D]">{adminUser?.name || "User"}</p>
        ...
        <main className="flex h-full min-h-0 min-w-0 flex-col overflow-hidden">
          <header className="flex w-full flex-col gap-4 bg-white px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-[#2D2D2D]/45">Explore your catalogs, track shipments, and manage your orders seamlessly</p>
            </div>
