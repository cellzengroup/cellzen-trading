...
export default function CostumerDashboard() {
  ...
  return (
    <section className="min-h-screen bg-[#EAE8E5] px-6 py-8">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-[#2D2D2D]/60">
              Track your orders, review shipment milestones, and stay connected with Cellzen support from one place.
            </p>
          </div>

          <div className="grid gap-4 sm:grid-cols-2">
            {["Active Shipments", "Documents", "Delivery Updates", "Support Requests"].map((item) => (
