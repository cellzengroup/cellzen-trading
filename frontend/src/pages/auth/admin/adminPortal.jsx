...
const NAV_LINKS = [
  ...
  { title: "PI Generator", path: "/admin-invoices", icon: "invoices" },
  { title: "Billing Invoice", path: "/admin-billing-invoices", icon: "billing" },
      ...
      >
        <aside className="flex h-full flex-col overflow-hidden bg-white p-4">
          <div className={`flex items-center ${sidebarCollapsed ? "justify-center" : "justify-between"} gap-3`}>
            <Link to="/admin-dashboard" aria-label="Admin dashboard" className="flex min-w-0 items-center gap-2">
        ...
        <main className="flex h-full min-h-0 min-w-0 flex-col overflow-hidden">
          <header className="flex w-full flex-col gap-4 bg-white px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-[#2D2D2D]">Welcome to Admin Dashboard</h1>
              <p className="mt-1 text-xs text-[#2D2D2D]/45">Manage your Cellzen operations, products, reports, and settings</p>
            </div>
