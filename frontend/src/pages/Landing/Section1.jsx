...
export default function Section1() {
  ...
  {!greetDone && (
  <span
  className="inline-block w-[2px] ml-1  animate-pulse"
  ...
  className="w-full  border border-white/15 bg-white/5 px-6 py-4 pr-14 text-sm text-white placeholder-white/30 backdrop-blur-md outline-none transition-all duration-300 focus:border-cz-secondary-light/50 focus:bg-white/8 focus:shadow-[0_0_20px_rgba(185,147,83,0.15)]"
  ...
  <div className="w-full  border border-white/15 bg-white/5 px-6 py-4 pr-14 text-sm text-white/30 backdrop-blur-md">
  Loading...
  </div>
  )}
  <button
  type="submit"
  className="absolute right-2 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center  bg-cz-secondary-light text-white transition-all duration-300 hover:bg-cz-secondary-light/90 hover:scale-110 hover:shadow-[0_0_20px_rgba(185,147,83,0.4)] active:scale-95"
  >
